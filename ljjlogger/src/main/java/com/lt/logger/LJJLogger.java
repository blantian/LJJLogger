 ...
 * Time： 14:51
 */
public class LJJLogger {
    private static final String TAG = "LJJLogger";
    ...
    static void onListenerLogWriteStatus(String name, int status) {
        if (name.equals(LJJLoggerStatus.MGLOGGER_INIT_STATUS)) {
            isHookOrFork = status == LJJLoggerStatus.MGLOGGER_OK;
        }
