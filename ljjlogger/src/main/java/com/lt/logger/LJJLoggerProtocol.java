 ...
 * Time： 10:25
 */
public class LJJLoggerProtocol implements ILogger {
    ...
    private static volatile LJJLoggerProtocol instance;
    ...
    private LJJLoggerProtocol() {}

    public static LJJLoggerProtocol get() {
        if (instance == null) {
            synchronized (LJJLoggerProtocol.class) {
                if (instance == null) {
                    instance = new LJJLoggerProtocol();
                }
            }
        }
        return instance;
