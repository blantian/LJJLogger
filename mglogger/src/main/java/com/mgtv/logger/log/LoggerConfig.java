...
public final class LoggerConfig {
    ...
    /* =================== Getter =================== */
    @NonNull public String getCachePath()       { return cachePath; }
    @NonNull public String getLogDir()          { return logDir; }
    public      int        getLogCacheS()       { return logCacheS; }
    public      long getMaxLogFileBytes()         { return maxLogFileBytes; }
    public      long getMaxSdCardBytes()       { return maxSdCardBytes; }
    public      int        getMaxQueue()        { return maxQueue; }
    @NonNull public String getKey16()           { return key16; }
    @NonNull public String getIv16()            { return iv16; }
    @NonNull public List<String> getLogcatBlackList() { return logcatBlackList; }
