...
{
    if (!class_J4AC_android_os_Build__VERSION.id || !class_J4AC_android_os_Build__VERSION.field_SDK_INT) {
        J4A_ALOGE("J4A Error: android.os.Build$VERSION.SDK_INT not initialized correctly.\n");
        return 0;
    }
...
{
    if (!class_J4AC_android_os_Build__VERSION.id || !class_J4AC_android_os_Build__VERSION.field_SDK_INT) {
        J4A_ALOGE("J4A Error: android.os.Build$VERSION.SDK_INT not initialized correctly in catchAll.\n");
...
{
    if (!class_J4AC_android_os_Build__VERSION.id || !class_J4AC_android_os_Build__VERSION.field_SDK_INT) {
        J4A_ALOGE("J4A Error: android.os.Build$VERSION.SDK_INT not initialized correctly for set.\n");
        return;
    }
